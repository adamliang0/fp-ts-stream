 ...
 * @__PURE__
 */
export function allM<F extends URIS4>(
	M: Monad4<F>,
): <S, R, E>(
 ...
 * @__PURE__
 */
export function allM<F extends URIS3>(
	M: Monad3<F>,
 ...
 *  @__PURE__
 */
export function allM<F extends URIS3, E>(
	M: Monad3C<F, E>,
 ...
 * @__PURE__
 */
export function allM<F extends URIS2>(
	M: Monad2<F>,
 ...
 * @__PURE__
 */
export function allM<F extends URIS2, E>(
	M: Monad2C<F, E>,
 ...
 * @__PURE__
 */
export function allM<F extends URIS>(
	M: Monad1<F>,
