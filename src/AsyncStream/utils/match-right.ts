 ...
 * @__PURE__
 */
export function matchRightW<B, A, C>(
	onEmpty: Lazy<B> | Task<B>,
	onNonEmpty: (init: AsyncStream<A>, last: A) => C | Promise<C>,
) {
	/**
 ...
 * @__PURE__
 */
export function matchRight<B, A>(
	onEmpty: Lazy<B> | Task<B>,
	onNonEmpty: (init: AsyncStream<A>, last: A) => B | Promise<B>,
) {
