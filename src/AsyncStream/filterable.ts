...
): <B extends A>(fa: AsyncStream<B>) => AsyncStream<B>;
...
export function filterMapWithIndex<A, B>(
	f: (i: number, a: A) => MaybeAsync<Option<B>>,
) {
	/**
...
export function filterWithIndex<A>(
	predicateWithIndex: AsyncPredicateWithIndex<number, A>,
): <B extends A>(fa: AsyncStream<B>) => AsyncStream<B>;
...
export function partition<A>(
	...
	fb: AsyncStream<B>,
) => Separated<AsyncStream<B>, AsyncStream<B>>;
...
export function partition<A>(
	predicate: AsyncPredicate<A>,
): (fb: AsyncStream<A>) => Separated<AsyncStream<A>, AsyncStream<A>>;
export function partition<A>(
	predicate: AsyncPredicate<A>,
): (fb: AsyncStream<A>) => Separated<AsyncStream<A>, AsyncStream<A>> {
...
export function partitionWithIndex<A>(
	predicateWithIndex: AsyncPredicateWithIndex<number, A>,
): (fa: AsyncStream<A>) => Separated<AsyncStream<A>, AsyncStream<A>>;
export function partitionWithIndex<A>(
	predicateWithIndex: AsyncPredicateWithIndex<number, A>,
): (fa: AsyncStream<A>) => Separated<AsyncStream<A>, AsyncStream<A>> {
	/**
...
export function partitionMapWithIndex<A, B, C>(
	f: (i: number, a: A) => MaybeAsync<Either<B, C>>,
) {
	/**
	 ...
	 * @__PURE__
	 */
	return function _partitionMapWithIndex(
		fa: AsyncStream<A>,
	): Separated<AsyncStream<B>, AsyncStream<C>> {
		return pipe(fa, mapWithIndex(f), separate);
	};
}
...
export const Filterable: Filterable1<URI> = {
	...
	filter<A>(fa: AsyncStream<A>, p: Predicate<A>) {
		return filter(p)(fa);
	},
	filterMap(fa, f) {
		return filterMap(f)(fa);
	},
	partition<A>(fa: AsyncStream<A>, p: Predicate<A>) {
		return partition(p)(fa);
	},
	partitionMap(fa, f) {
		return partitionMap(f)(fa);
	},
};
...
export const FilterableWithIndex: FilterableWithIndex1<URI, number> = {
	...
	filterMapWithIndex(fa, f) {
		return filterMapWithIndex(f)(fa);
	},
	filterWithIndex<A>(
		fa: AsyncStream<A>,
